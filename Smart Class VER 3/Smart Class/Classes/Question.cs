...
namespace Smart_Class
{
    public class Question
    {
        ...
        public Question(string description, string questionText, string correctAnswer,string falseAnswerFirst, string falseAnswerSecond, string falseAnswerThird, string subject, Image questionPicture)
        {
